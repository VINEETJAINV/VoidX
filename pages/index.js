        ...
        <div className="flex items-center gap-2">
          ...
          <SignedIn>
            <nav className="flex items-center gap-4">
              <a href="#feed" className="text-indigo-600 dark:text-indigo-300 font-semibold hover:underline">Feed</a>
              <a href="/profile" className="text-indigo-600 dark:text-indigo-300 font-semibold hover:underline">Profile</a>
              <UserButton />
            </nav>
          </SignedIn>
        </div>
        ...
        <SignedIn>
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-4">
              <a
                href="#feed"
                className="px-7 py-2 rounded-xl font-bold shadow-lg bg-white/20 dark:bg-zinc-900/40 border-2 border-transparent bg-clip-padding backdrop-blur-md text-indigo-700 dark:text-indigo-200 hover:border-indigo-400 dark:hover:border-indigo-500 hover:scale-105 transition-all duration-200 ring-1 ring-indigo-200 dark:ring-indigo-700"
              ...
              <a
                href="/profile"
                className="px-7 py-2 rounded-xl font-bold shadow-lg bg-white/20 dark:bg-zinc-900/40 border-2 border-transparent bg-clip-padding backdrop-blur-md text-pink-600 dark:text-pink-300 hover:border-pink-400 dark:hover:border-pink-500 hover:scale-105 transition-all duration-200 ring-1 ring-pink-200 dark:ring-pink-700"
